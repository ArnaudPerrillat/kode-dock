...
>(({ children, ...slotProps }, ref) => {
  ...
  return React.cloneElement(children as React.ReactElement, {
    ...
    ref,
    className: cn(
      (slotProps as Record<string, unknown>).className as string,
...
function SidebarProvider({
  ...
  const [_open, _setOpen] = React.useState(() => {
    ...
    if (cookie) return cookie.split("=")[1] !== "false"
    return defaultOpen
  })
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-side={side}
    >
      {/* Spacing placeholder that pushes main content */}
      <div
        className={cn(
  ...
  return (
    <main
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-1rem)] md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm",
        className
      )}
      {...props}
    />
